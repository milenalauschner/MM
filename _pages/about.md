...
excerpt: "Instituto de Física |<br /> Tutorial sobre o uso do software Insight Maker| <br /><br /> Autores: Milena Lauschner Lopes, Leonardo Albuquerque Heidemann e Eliane Angela Veit"
layout: single
permalink: /about/
image: <img align="left" width="100" height="100" src="{{ site.url }}{{ site.baseurl}}/assets/images/IF.png">
header:
